...
const translations = {
  en: {
    ...
    forgotPassword: {
      ...
      successSub: 'If this email exists in our system, you will receive a reset link shortly.',
      backToLogin: 'Back to sign in',
      error: 'Something went wrong. Please try again.',
    },
    resetPassword: {
      heading: 'Choose a new password',
      sub: 'Pick a strong password you have not used before.',
      ...
      errorMatch: 'Passwords do not match.',
      errorLength: 'Password must be at least 8 characters.',
      errorFailed: 'Invalid or expired reset link.',
      backToLogin: 'Back to sign in',
      toastSuccess: 'Password updated',
  ...
  fr: {
    ...
    forgotPassword: {
      heading: 'Réinitialiser votre mot de passe',
      sub: 'Entrez votre courriel et nous vous enverrons un lien de réinitialisation.',
      emailLabel: 'Adresse courriel',
      emailPlaceholder: 'vous@votreagence.com',
      submit: 'Envoyer le lien',
      sending: 'Envoi en cours...',
      successHeading: 'Vérifiez votre boite de réception',
      successSub: 'Si ce courriel existe dans notre système, vous recevrez un lien de réinitialisation sous peu.',
      backToLogin: 'Retour à la connexion',
      error: 'Une erreur est survenue. Veuillez réessayer.',
    },
    resetPassword: {
      heading: 'Choisir un nouveau mot de passe',
      sub: 'Choisissez un mot de passe fort que vous n\'avez pas utilisé auparavant.',
      ...
      errorMatch: 'Les mots de passe ne correspondent pas.',
      errorLength: 'Le mot de passe doit contenir au moins 8 caractères.',
      errorFailed: 'Lien de réinitialisation invalide ou expiré.',
      backToLogin: 'Retour à la connexion',
      toastSuccess: 'Mot de passe mis à jour',
      toastSuccessDesc: 'Vous pouvez maintenant vous connecter avec votre nouveau mot de passe.',
    },
    comments: {
