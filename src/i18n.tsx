  ...
  en: {
    ...
    landing: {
      ...
      dashboard: {
        ...
        form: {
          showFigures: 'Show figures for',
          thisMonth: 'This month',
          comparePeriod: 'Compare period by',
          mtd: 'Month-to-date (MTD)',
          setTargetsMonth: 'Set targets (This month)',
          setTargetsYear: 'Set targets (This year)',
          save: 'Save',
          cancel: 'Cancel',
        },
        videoStarts: {
    ...
    landing: {
      ...
      dashboard: {
        clicks: {
          ...
          value: '6 896',
          change: '-3 382 (33%)',
          caption: 'Par rapport a hier',
          label: 'Objectif mensuel atteint',
          min: '389K',
          max: '425K',
          impressions: 'Impressions',
        },
        form: {
          showFigures: 'Afficher les chiffres pour',
          thisMonth: 'Ce mois-ci',
          comparePeriod: 'Comparer la periode par',
          mtd: 'Mois en cours (MTD)',
          setTargetsMonth: 'Objectifs (ce mois)',
          setTargetsYear: 'Objectifs (cette annee)',
          save: 'Enregistrer',
          cancel: 'Annuler',
        },
        videoStarts: {
          title: 'Demarrages video',
          period: "aujourd'hui",
          value: '0',
          change: '0',
          caption: 'Par rapport a hier',
          videoClicks: 'Clics video',
        }
      }
    },
    signup: {
