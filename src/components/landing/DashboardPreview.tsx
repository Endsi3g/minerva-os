        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          ...
          <div className="bg-white rounded-2xl p-5 flex flex-col gap-4 shadow-sm">
            <div className="flex justify-between items-start">
              <div>
                <h4 className="text-[#ef4d23] text-[13px] font-semibold">{d.clicks.title}</h4>
                <p className="text-neutral-400 text-[12px]">{d.clicks.period}</p>
              </div>
            </div>
            
            <div className="flex items-baseline gap-2">
              <span className="text-[28px] font-semibold text-neutral-900">{d.clicks.value}</span>
              <div className="bg-red-50 text-red-600 rounded-full px-2 py-0.5 flex items-center gap-1 text-[11px] font-medium">
                <TrendingDown size={12} />
                {d.clicks.change}
              </div>
            </div>
            
            <p className="text-[11px] text-neutral-400 -mt-2">{d.clicks.caption}</p>
            
            <div className="flex flex-col items-center gap-2 py-2">
              <p className="text-[12px] font-medium text-neutral-700">{d.clicks.label}</p>
              <Gauge value={92} showLabels min={d.clicks.min} max={d.clicks.max} />
            </div>

            <div className="bg-neutral-100 rounded-full p-1 flex mt-auto">
              <button className="flex-1 text-[11px] font-semibold py-1.5 rounded-full bg-white shadow-sm">{d.clicks.impressions}</button>
              <button className="flex-1 text-[11px] font-semibold py-1.5 rounded-full text-neutral-500">{d.clicks.title}</button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-5 flex flex-col gap-4 shadow-sm">
            <div className="flex justify-between items-start">
              <div>
                <h4 className="text-[#ef4d23] text-[13px] font-semibold">{d.videoStarts.title}</h4>
                <p className="text-neutral-400 text-[12px]">{d.videoStarts.period}</p>
              </div>
            </div>

            <div className="flex items-baseline gap-2">
              <span className="text-[28px] font-semibold text-neutral-900">{d.videoStarts.value}</span>
              <div className="bg-neutral-50 text-neutral-400 rounded-full px-2 py-0.5 flex items-center gap-1 text-[11px] font-medium">
                <TrendingUp size={12} />
                {d.videoStarts.change}
              </div>
            </div>

            <p className="text-[11px] text-neutral-400 -mt-2">{d.videoStarts.caption}</p>
            ...
            <div className="bg-neutral-100 rounded-full p-1 flex mt-auto">
              <button className="flex-1 text-[11px] font-semibold py-1.5 rounded-full bg-white shadow-sm">{d.videoStarts.videoClicks}</button>
              <button className="flex-1 text-[11px] font-semibold py-1.5 rounded-full text-neutral-500">{d.videoStarts.title}</button>
            </div>
          </div>
